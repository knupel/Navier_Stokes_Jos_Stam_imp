...
class iVec2 extends iVec {
  ...
  public iVec2 set(int x, int y) {
    this.x = this.u = this.s = x;
    this.y = this.v = this.t = y;
    return this;
  }
...
class iVec3 extends iVec {
  ...
  public iVec3 set(int x, int y, int z) {
    this.x = this.s = this.r = x;
    this.y = this.t = this.g = y;
    this.z = this.p = this.b = z;
    return this;
  }
